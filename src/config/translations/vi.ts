...
export const viTranslations: LanguageTranslations = {
    ...
    chat_words_ready_quiz: "{count} từ sẵn sàng làm Quiz luyện tập",
    chat_word_ready_quiz: "{count} từ sẵn sàng làm Quiz luyện tập",
    ...
    chat_practice_start_today_action: "🎯 Bắt Đầu Luyện Tập Hôm Nay",
