...
export const viTranslations: LanguageTranslations = {
    ...
    chat_sandwich_warmup_title: "🥪 **Phiên Học Cân Bằng Sandwich (Bước 1/3: Khởi Động)**",
    chat_sandwich_warmup_desc: "Khám phá **{count} từ vựng khởi động** trước với phát âm và ví dụ. Tiếp theo là Confuser Duel (Bước 2) và Trắc Nghiệm Ôn Tập (Bước 3)!",
    chat_sandwich_start_duel_action: "⚔️ Bắt Đầu Confuser Duel (Bước 2/3) ➔",
    chat_sandwich_start_quiz_action: "🎯 Bắt Đầu Trắc Nghiệm Ôn Tập (Bước 3/3) ➔",
    ...
    chat_sandwich_review_all_cards_toast: "Vui lòng xem đủ {total} thẻ khởi động trước khi vào Confuser Duel (còn {remaining} thẻ).",
    chat_sandwich_duel_intro: "🥪 **Phiên Học Cân Bằng (Bước 2/3: Đối Đầu Confuser)**\n---\nPhân biệt từ mục tiêu với các đối thủ dễ gây nhầm lẫn để xóa bỏ lỗi cố hữu!\n\n### Thử thách 1 / {total} (⚔️ Confuser Duel):\n**{question}**",
    chat_sandwich_step2_finished_msg: "{feedback}\n---\n🎉 **Hoàn Thành Bước 2: Confuser Duel! (2/3)**\n\nBạn đã phân biệt xuất sắc các cặp từ dễ gây nhầm lẫn! Kết quả: **{score} / {total}** ({accuracy}% chính xác).\n\nSẵn sàng bước cuối cùng để trắc nghiệm ghi nhớ toàn bộ từ vựng?",
    chat_sandwich_quiz_intro: "🥪 **Phiên Học Cân Bằng (Bước 3/3: Trắc Nghiệm Ôn Tập)**\n---\n### Câu hỏi 1 / {total} ({qTag}):\n**{question}**",
