...
export const enTranslations: LanguageTranslations = {
    ...
    auto_enrich_all_tooltip: "Automatically enrich all incomplete words with AI in background",
    ...
    incomplete_multiple_defs_tooltip: "Multiple definitions found by AI. Click to choose your intended definition.",
