...
export const enTranslations: LanguageTranslations = {
    ...
    chat_sandwich_warmup_desc: "Explore these **{count} warm-up word(s)** first with pronunciation and examples. Next, we'll run Confuser Duel (Step 2) and Practice Quiz (Step 3)!",
    chat_sandwich_start_duel_action: "⚔️ Start Confuser Duel (Step 2/3) ➔",
    chat_sandwich_start_quiz_action: "🎯 Start Practice Quiz (Step 3/3) ➔",
    ...
    chat_sandwich_review_all_cards_toast: "Please review all {total} warm-up flashcards before starting Confuser Duel ({remaining} remaining).",
    chat_sandwich_duel_intro: "🥪 **Smart Balanced Session (Step 2/3: Confuser Duel)**\n---\nBreak fossilized errors by contrasting each target word against its trickiest rival!\n\n### Challenge 1 of {total} (⚔️ Confuser Duel):\n**{question}**",
    chat_sandwich_step2_finished_msg: "{feedback}\n---\n🎉 **Step 2 Completed: Confuser Duel! (2/3)**\n\nGreat work breaking fossilized confusion! You scored **{score} / {total}** ({accuracy}% accuracy).\n\nReady for the final step to test retention across your vocabulary?",
    chat_sandwich_quiz_intro: "🥪 **Smart Balanced Session (Step 3/3: Practice Quiz)**\n---\n### Question 1 of {total} ({qTag}):\n**{question}**",
    chat_sandwich_q_warmup_tag: "Warm-up Check 🥪",
    chat_sandwich_q_review_tag: "Core Review 🔄",
    chat_sandwich_q_duel_tag: "Confuser Duel ⚔️",
    chat_sandwich_finished_msg: "{feedback}\n---\n🎉 **Smart Balanced Session Completed! (3/3)**\n\nYou successfully finished the full **Balanced Learning Loop**:\n1. 🎴 **Warm-up**: Contextual immersion with target vocabulary\n2. ⚔️ **Confuser Duel**: Contrasted rival words to break fossilized errors\n3. 🎯 **Practice Quiz**: Core retrieval & immediate retention check!\n\n🏆 **Final Score: {score} out of {total}** ({accuracy}% accuracy)\n\nI have updated your memory strength history and spaced repetition schedules!",
